...
export default function CityNameToLasVegasPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section - Customize colors and city name */}
      <section className="bg-gradient-to-br from-[PRIMARY_COLOR]-600 via-[PRIMARY_COLOR]-700 to-[PRIMARY_COLOR]-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 bg-[PRIMARY_COLOR]-500 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-4 h-4 mr-2" />
              [City Name] → Las Vegas
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Moving from [City Name] to Las Vegas?</h1>
            <p className="text-xl md:text-2xl [PRIMARY_COLOR]-100 mb-8 max-w-3xl mx-auto">
              Let Dr. Jan Duffy and the Berkshire Hathaway team make your transition seamless. We
              understand the [City Name] lifestyle and will help you find your perfect Las Vegas home.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                type="button"
                className="bg-white text-[PRIMARY_COLOR]-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors"
              >
                Get Free Consultation
              </button>
              <button
                type="button"
                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-[PRIMARY_COLOR]-600 transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the advantages of living in Las Vegas compared to [City Name]
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl">
              <div className="w-16 h-16 bg-[PRIMARY_COLOR]-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                <DollarSign className="w-8 h-8 text-[PRIMARY_COLOR]-600" />
              </div>
              ...
              <p className="text-gray-600 text-center">
                ...
                your pocket compared to [City Name].
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600 text-center">
                ...
                compared to [City Name]'s [housing type].
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600 text-center">
                Enjoy 300+ days of sunshine annually. Say goodbye to [City Name] [weather characteristic] and hello to
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600 text-center">
                McCarran International Airport offers direct flights to [City Name] and major cities
                worldwide.
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We handle every detail of your move from [City Name] to Las Vegas
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-[PRIMARY_COLOR]-600 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="h-48 bg-gradient-to-br from-[PRIMARY_COLOR]-400 to-[PRIMARY_COLOR]-600"></div>
              <div className="p-6">
      ...
      {/* Contact Section */}
      <section className="py-20 bg-[PRIMARY_COLOR]-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Ready to Start Your [City Name] to Vegas Journey?
            </h2>
            <p className="text-xl [PRIMARY_COLOR]-100 max-w-3xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <Phone className="w-5 h-5 mr-3 text-[PRIMARY_COLOR]-200" />
                  <span>(702) 707-7273</span>
                </div>
                <div className="flex items-center">
                  <Mail className="w-5 h-5 mr-3 text-[PRIMARY_COLOR]-200" />
                  <span>DrJan@LasVegasRelocationServices.com</span>
                </div>
                <div className="flex items-center">
                  <Calendar className="w-5 h-5 mr-3 text-[PRIMARY_COLOR]-200" />
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2 text-[PRIMARY_COLOR]-100">
                  ...
                  <li>• Deep knowledge of [City Name] to Vegas relocation</li>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    id="city-fullName"
                    type="text"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[PRIMARY_COLOR]-500 focus:border-transparent"
                ...
                <div>
                  <label
                    htmlFor="city-neighborhood"
                    className="block text-sm font-medium text-gray-700 mb-2"
                  >
                    Current [City Name] Neighborhood
                  </label>
                  <input
                    id="city-neighborhood"
                    type="text"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[PRIMARY_COLOR]-500 focus:border-transparent"
                    placeholder="e.g., [City-specific neighborhoods]"
                  />
                </div>

                <div>
                  <label
                    htmlFor="city-moveDate"
                    className="block text-sm font-medium text-gray-700 mb-2"
                  >
                    Target Move Date
                  </label>
                ...
                <button
                  type="submit"
                  className="w-full bg-[PRIMARY_COLOR]-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-[PRIMARY_COLOR]-700 transition-colors"
                >
