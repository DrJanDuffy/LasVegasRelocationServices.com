...
export async function GET() {
  const baseUrl = 'https://www.lasvegas-relocation.com';
  const content = `# Las Vegas Relocation Services — Dr. Jan Duffy
> Expert relocation services for families and professionals moving to Las Vegas
## About
