      ...
      <div className="container mx-auto container-padding">
        ...
        >
          ...
          <p className="text-xl text-secondary-600 max-w-3xl mx-auto">
            ...
            experience exceptional. Each team member brings unique expertise and a commitment to
            excellence.
          </p>
        </motion.div>
            ...
            >
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-secondary-600 mb-4 leading-relaxed">{member.bio}</p>

                  {/* Specialties */}
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold text-secondary-700 mb-2">Specialties:</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="p-6 bg-secondary-50 rounded-xl">
              ...
              <p className="text-secondary-700">
                Continuously improving our processes and embracing new solutions.
              </p>
            </div>
          </div>
        </motion.div>
